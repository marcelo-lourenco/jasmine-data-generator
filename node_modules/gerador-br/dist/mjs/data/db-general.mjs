...
const coresPele = ['Branca', 'Preta', 'Parda', 'Amarela', 'Outro'];
...
export { categoriasCnh, coresPele, escolaridades, identidadesGenero, identidadesPorOrientacao, nicknames, nomesDoMeio, nomesFemininos, nomesMasculinos, orientacoesSexual, palavras, profissoes, provedoresEmail, siglasEstados, sobrenomes, tiposSanguineo };
