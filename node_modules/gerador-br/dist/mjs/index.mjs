import { listaCodigosBancos, banco } from './generators/banco.mjs';
import { sentenca, palavra, paragrafo } from './generators/texto.mjs';
import { placaMercosul, placaAntiga } from './generators/placa.mjs';
import { apelido } from './generators/apelido.mjs';
...
import { cnhCategoria } from './generators/cnh-categoria.mjs';
import { cnpj } from './generators/cnpj.mjs';
import { cnpjAlfanumerico } from './generators/cnpj-alfanumerico.mjs';
...
import { corPele } from './generators/corPele.mjs';
...
import { escolaridade } from './generators/escolaridade.mjs';
import { genero } from './generators/genero.mjs';
import { identidadeGenero } from './generators/identidade-genero.mjs';
import { identidadePorOrientacao } from './generators/identidade-por-orientacao.mjs';
import { inscricaoEstadual } from './generators/inscricao-estadual.mjs';
import { nome } from './generators/nome.mjs';
import { nomeEmpresa } from './generators/nome-empresa.mjs';
import { orientacaoSexual } from './generators/orientacao-sexual.mjs';
import { passaporte } from './generators/passaporte.mjs';
import { pis } from './generators/pis.mjs';
import { profissao } from './generators/profissao.mjs';
import { provedorEmail } from './generators/provedor-email.mjs';
import { renavam } from './generators/renavam.mjs';
import { rg } from './generators/rg.mjs';
import { telefone } from './generators/telefone.mjs';
import { tipoSanguineo } from './generators/tipo-sanguineo.mjs';
...
export { apelido, banco, cartaoCredito, celular, cep, certidao, cnh, cnhCategoria, cnpj, cnpjAlfanumerico, cns, codigoOperadora, contaBancaria, corPele, cpf, dataNascimento, ddd, email, endereco, escolaridade, genero, gerar, identidadeGenero, identidadePorOrientacao, inscricaoEstadual, listaCodigosBancos, nome, nomeEmpresa, orientacaoSexual, palavra, paragrafo, passaporte, pis, placaAntiga, placaMercosul, profissao, provedorEmail, renavam, rg, sentenca, telefone, tipoSanguineo, tituloEleitor };
