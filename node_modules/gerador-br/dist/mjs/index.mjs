...
export { apelido, banco, cartaoCredito, celular, cep, certidao, cnh, cnhCategoria, cnpj, cnpjAlfanumerico, cns, codigoOperadora, contaBancaria, corPele, cpf, dataNascimento, ddd, email, endereco, escolaridade, genero, gerar, identidadeGenero, identidadePorOrientacao, inscricaoEstadual, listaCodigosBancos, nome, orientacaoSexual, palavra, paragrafo, passaporte, pis, placaAntiga, placaMercosul, profissao, provedorEmail, renavam, rg, sentenca, telefone, tipoSanguineo, tituloEleitor };
