...
const nome = {
   ...
   */
  aleatorio() { return utils.getRandom([...dbGeneral.nomesFemininos, ...dbGeneral.nomesMasculinos]); },
   ...
   */
  masculino() { return utils.getRandom(dbGeneral.nomesMasculinos); },
   ...
   */
  feminino() { return utils.getRandom(dbGeneral.nomesFemininos); },
   ...
   */
  doMeio() { return utils.getRandom(dbGeneral.nomesDoMeio); },

  /**
   * Um sobrenome aleatório.
   * @returns {string} Retorna qualquer sobrenome, como "Alves", "Amorim", etc.
   */
  sobrenome() { return utils.getRandom(dbGeneral.sobrenomes); }
};
